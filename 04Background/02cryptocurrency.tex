...
% 
\footnotetest{Not all currencies use public-key cryptography. For example Fawkescoin, only uses hashing for both state consensus and currency ownership~\cite{Bonneau2014FawkescoinCryptography}}.
